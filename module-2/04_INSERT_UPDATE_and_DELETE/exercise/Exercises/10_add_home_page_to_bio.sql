...
WHERE home_page IS NOT NULL AND person.birthday < '19500101';

-- SELECT person_name, birthday, biography, home_page
-- FROM person
-- WHERE person.birthday < '19500101' AND home_page IS NOT NULL;